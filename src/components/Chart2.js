...
export default function Chart2(props) {
  ...
  for (var i =0; i<dataArray.length; i++) {
    ...
    var obj = {
      date: taken,
      Pulse: dataArray[i].pulse
        }
    data.push(obj)
  }
  return (
    <React.Fragment>
      <Title>Pulse Trend</Title>
      <ResponsiveContainer>
        <LineChart
          data={data}
          margin={{
        ...
        >
          ...
          <Line type="monotone" dataKey="Pulse" stroke="#3F51B5"  dot={{ stroke: '#3F51B5', strokeWidth: 2, fill: '#3F51B5' }} label={<CustomizedLabel />} />
        </LineChart>
      </ResponsiveContainer>
    </React.Fragment>
  );
